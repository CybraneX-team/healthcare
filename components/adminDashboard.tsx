...
export function AdminDashboard({
  ...
  const { programData, userCompletedVideos , allProgrammes, stats, recentActivity } = useProgramContext();
  ...
  return (
    ...
    {recentFour.length ? (
      ...
      <div className="p-6 text-center text-sm text-gray-500 italic">
        No recent activity yet. Try creating a program, module, or video to get
        things started!
      </div>
    )}
  </div>
