...
interface ModuleOverviewProps {
  programId: string;
  onModuleSelect: (moduleId: string, videoId: string, moduleTitle : string , videoTitle : string ) => void;
  onBack: () => void;
        ...
        <div className="space-y-4">
          {Object.values(programData.modules ?? {}).map((module: any) => {
            ...
            >
              ...
              {/* Videos display (if any) */}
              {expandedSections[module.id] && module.videos && (
                <div>
                  {Object.values(module.videos ).map((video: any) => (
                    <div
                      key={video.id}
                      className="flex items-center p-4 hover:bg-gray-50 cursor-pointer"
                      onClick={() => onModuleSelect(module.id, video.id, module.title , video.title)}
                    >
                      <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-900">Pre-recorded</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-900">Once a Week</span>
                </div>
              </div>
            </div>
