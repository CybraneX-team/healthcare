    ...
    <div className="h-full overflow-y-auto md:overflow-y-hidden p-4 text-black md:-mt-3">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="md:col-span-8">
          <div className="bg-white rounded-3xl shadow-sm h-auto p-4 md:p-6">
        ...
        <motion.div variants={itemVariants} className="md:col-span-4">
          <div className="bg-white rounded-3xl shadow-sm h-[110%] p-4 md:p-6">
        ...
        <motion.div
          ...
          className="md:col-span-4 mt-6 md:-mt-6"
        >
          <div className="bg-white rounded-3xl shadow-sm h-auto p-4 md:p-6">
        ...
        <motion.div
          variants={itemVariants}
          className="md:col-span-4 mt-0 md:-mt-6"
        >
          <div className="bg-white rounded-3xl shadow-sm h-auto p-4 md:p-6">
            <div className="flex justify-between items-start">
              ...
              <div className="text-right flex flex-col">
                ...
                <span className="text-3xl font-bold text-gray-900 ml-4">
                  {toxicBurden}
                </span>
              </div>
            </div>
