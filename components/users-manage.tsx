...
export function UsersManager({ setSidebarOpen }: UsersManagerProps) {
  ...
  const handleEditUser = async () => {
    ...
    try {
      ...
      const parsedDOB = selectedUser.dateOfBirth
        ...
        : null
      const isValidDate =
        parsedDOB instanceof Date && !isNaN(parsedDOB.valueOf())
  ...
  const openEditDialog = (user: any) => {
    ...
    if (timestamp?.seconds) {
      ...
      formattedDOB = new Date(timestamp.seconds * 1000)
        .toISOString()
        .split('T')[0]
              ...
              <div className="space-y-4 py-4">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = e.target.value
                        .replace(/\D/g, '')
                        .slice(0, 10) // remove non-digits and trim to 10
                ...
                <div className="space-y-2 flex items-center">
                  <input
                    ...
                    onChange={(e) =>
                      setNewUser({ ...newUser, use2FA: e.target.checked })
                    }
                  />
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="edit-diagnosis"
                    type="text"
                    value={selectedUser.primaryDiagnosis || ''}
                    onChange={(e) =>
                      setSelectedUser({
                        ...selectedUser,
                        primaryDiagnosis: e.target.value,
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="edit-medications"
                    type="text"
                    value={selectedUser.medications || ''}
                    onChange={(e) =>
                      setSelectedUser({
                        ...selectedUser,
                ...
                <div className="flex items-center space-x-2">
                  <input
                    type="checkbox"
                    id="edit-2fa"
                    checked={selectedUser.use2FA || false}
                    onChange={(e) =>
                      setSelectedUser({
                        ...selectedUser,
                  ...
                  />
                  <label htmlFor="edit-2fa" className="text-sm font-medium">
                    Enable Two-Factor Authentication
                  </label>
                </div>
              </div>
            ...
            <DialogContent className="sm:max-w-[600px] mx-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {selectedUserForDetails.joinedDate}
                </div>

                <div>
                  <strong>Documents:</strong>
                  {selectedUserForDetails.documents &&
                  Object.keys(selectedUserForDetails.documents).length > 0 ? (
                    <ul className="space-y-2 mt-2">
                      {Object.entries(selectedUserForDetails.documents).map(
                        ([docName, docData]: any) => (
                          <li key={docName}>
