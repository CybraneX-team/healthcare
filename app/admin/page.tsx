...
export default function AdminPage() {
  ...
  return (
    <ProgramProvider
      programId={selectedProgram || 'dewdw'}
          ...
          {activeView === 'modules' && !selectedProgram && (
            <div className="p-8 flex flex-col items-center text-center gap-4">
              ...
              <p className="text-gray-500 max-w-sm">
                Choose a programme in the{' '}
                <span className="font-medium">Programs</span> section before
                managing its modules.
              </p>
              <Button
          ...
          {activeView === 'videos' && (!selectedProgram || !selectedModule) && (
            <div className="p-8 flex flex-col items-center text-center gap-4">
              ...
              <p className="text-gray-500 max-w-sm">
                ...
                <span className="font-medium">Modules</span> section before
                managing its videos.
              </p>
              <Button
